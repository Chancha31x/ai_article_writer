document.addEventListener('DOMContentLoaded', () => {
    ...
    const BACKEND_API_URL = 'https://564c-147-50-230-61.ngrok-free.app/generate-content'; // <--- อัปเดตเป็น HTTPS และ IP ของ Ubuntu Server (Port 443 เป็น default ไม่ต้องระบุ)
    // --- Global Variables ---
